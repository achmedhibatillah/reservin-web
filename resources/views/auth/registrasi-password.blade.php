<div class="bg-clrdark position-relative d-flex justify-content-center align-items-center" style="padding:100px 0;min-height:100vh">
    <div class="card bg-transparent text-light border-clrsecgold p-3 pt-4 pb-5 position-relative" style="z-index:10;width:310px;">
        ...
        <div class="">
            <div class="fsz-10 text-center">
                <hr>
                <div class="mb-3">
                    <p class="m-0 fsz-8">Nama lengkap</p>
                    <p class="m-0 lh-1 text-clr2">{{ $customer['customer_fullname'] }}</p>
                </div>
                <div class="mb-4">
                    <p class="m-0 fsz-8">Email</p>
                    <p class="m-0 lh-1 text-clr2">{{ $customer['customer_email'] }}</p>
                </div>
                <hr class="mb-4">
        ...
        <form method="POST" action="{{ url('registrasi') }}">
            @csrf
            <input type="hidden" name="customer_fullname" value="{{ $customer['customer_fullname'] }}">
            ...
            <button type="submit" class="btn btn-clrgold fsz-12 w-100 mt-4 mb-3">Registrasi</button>
        </form>
    </div>
